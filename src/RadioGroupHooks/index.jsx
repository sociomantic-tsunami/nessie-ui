...
} ) =>
{
    ...
    const realSelectedValue = selectedValue ?
    selectedValue : selectedValueState;

    let items = children ?
        Children.toArray( children ) : buildRadiosFromValues( values, onChange, selectedValue ? null : setSelectedValueState );

    items = items.map( item => React.cloneElement( item, {
        isChecked : item.props.value === realSelectedValue,
    } ) );
