...
describe( 'Radio', () =>
{
    ...
    describe( 'props', () =>
    {
        ...
        describe( 'onChange', () =>
        {
            ...
            test('should be passed as `undefined` to Checkable if readOnly', () =>
            {
                const onChange = sinon.stub().callsFake( e =>
                    targetChecked = e.target.checked
                );
                ...
                expect( wrapper.find( Checkable ).prop( onChange ) ).toBe(undefined);
            });
            ...
            test('should be defined if not readOnly', () =>
            {
                ...
                expect( wrapper.prop( onChange ) ).toBe(wrapper.instance().onChange);
            });
        } );
    } );
} );
