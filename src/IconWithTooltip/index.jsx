...
export default class IconWithTooltip extends React.Component
{
    ...
    render()
    {
        ...
        {
            console.warn( 'IconWithTooltip: this component is deprecated and \
will be removed in a future major release. Please compose from the Icon and \
Tooltip components instead.' );
